                    ...
                    <div class="row row-in">
                        <div class="col-lg-3 col-sm-6 row-in-br">
                            <ul class="col-in">
                                ...
                                <?php
                                    //pending orders
                                    $pendingOrders = $POrder->listPending();
                                    $allOrders = $POrder->list();

                                    //percentage of pending to fullfilled orders
                                    $orderPercentage = (count($pendingOrders)/count($allOrders))*100; 
                                    $orderPercentage = round($orderPercentage, 2); 
                                ?>  
                                <li class="col-last">
                                    <h3 class="counter text-right m-t-15"><?php echo count($pendingOrders); ?></h3>
                                </li>
                                <li class="col-middle">
                                    <h4>New purchase orders</h4>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="<?php echo $orderPercentage; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $orderPercentage; ?>%">
                                            <span class="sr-only"><?php echo $orderPercentage; ?>% are pending</span>
                                        </div>
                                    </div>
                                </li>
                            </ul>
