...
$("#purchaseOrderConfirmationForm").on('submit', function(e){
	...
	$.post(apiLink, {action:'confirmPurchaseOrder', supplierASN:ASNId, order:orderId, orderStatus:1, items:orderItemsFeedback, departureDate:departureDate, deliveryDate:deliveryDate, barcodeType:barcodeType, additionalFile:'', additionalNote:additionNotes, doneBy:currentUserId}, function(data){
		console.log(data)
