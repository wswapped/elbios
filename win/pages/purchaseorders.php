		...
		<div class="col-sm-12">
			<?php
				...
				if($page=='add'){
					...
					$js_files = array('../plugins/bower_components/moment/moment.js', '../plugins/bower_components/jquery-wizard-master/jquery.steps.min.js', '../plugins/bower_components/jquery-wizard-master/jquery.validate.min.js', '../plugins/bower_components/sweetalert/sweetalert.min.js', 'js/addOrder.js', 'js/jasny-bootstrap.js');
				}else{
